...
Motor-Movenet was later remastered for Trash-Bot the rec bot project 
...
class Move:
    ...
    def cleanup_PWM():
        """Use this function to clear only the PWM signals"""
        pwmA.stop(); pwmB.stop();
        
    def cleanup_all():
        """Use this function to clear both PWM signals ans clear all GPIO ports"""
        pwmA.stop(); pwmB.stop();
        GPIO.cleanup();
